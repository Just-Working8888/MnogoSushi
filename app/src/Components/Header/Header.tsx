...
const HeaderComponent: React.FC = () => {
    ...
    return (
        ...
        <header className={classes.header}>
            ...
            <nav style={!top ? { boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", transition: '0.3s', background: '#00092956', color: 'white' } : { background: '#00092956', color: 'white', transition: '0.3s', boxShadow: "rgba(0, 9, 41, 0.337) 0px 71px 38px" }} className={classes.header_nav}>
